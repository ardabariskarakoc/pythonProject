...
photoResized = photo.subsample(2, 2)
Button(window, text='Yükle', image=photoResized, compound=TOP).place(x=335, y=20)

Spinbox(frame3, from_=18, to=60, font=('Arial 12 bold'), bg='#ECE8F0', justify='center',
        width=19).pack(padx=5, pady=5)
...
rd1 = Radiobutton(frame3, text='Erkek', variable=ivar, value=1, command=sel, font='Arial, 12', bg='#D7C6EE')
rd2 = Radiobutton(frame3, text='Kadın', variable=ivar, value=2, command=sel, font='Arial, 12', bg='#D7C6EE')
